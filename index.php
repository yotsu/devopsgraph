...
<div class="header-container">
    <div>
        ...
        <form action="patrimoine.php" method="GET">
            <label for="patrimoine">Voir les résultats du patrimoine : </label>
            <select id="patrimoine" name="patrimoine">
            <?php
            foreach (get_patrimoine_name(null) as $key=>$val) {
...
<script>
    ...
    foreach ($chartSeries as $series) {
        ...
        $body .=
            ...
            'series'.$chartSeriesCounter.'.name = "'.ucfirst($series).'";'.

...
//$spreadsheet = $reader->load("results_one.xlsx");
$spreadsheet = $reader->load("resultats_finaux.xlsx");
...
//            'agileS' => $agile_sum,
//            'toolsSum' => $tools_sum,
//            'automationSum' => $automation_sum,
//            'qualitySum' => $quality_sum,
//            'securitySum' => $security_sum
        );
    }
}
...
//        array_shift($patrimoine);
        asort($patrimoine);
        return $patrimoine;
    }
}

function return_date($format) {
